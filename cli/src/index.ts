...
import { analyze, listSources, LOG_DIR, VALID_SOURCES, parseSince } from './analyzer.js';
...
function cmdTips(stats: Stats, flags: ParsedArgs['flags']): void {
...
function cmdReport(stats: Stats, flags: ParsedArgs['flags']): void {
